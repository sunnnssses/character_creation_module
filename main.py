...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает урон противнику в зависимотсти от персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокированный урон в зависимости от персонажа."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не исользовал блокировку')


def special(char_name: str, char_class: str) -> str:
    """Возвращает специальное умение в зависимости от персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Проводит тренировку нового игрока."""
    if char_class == 'warrior':
